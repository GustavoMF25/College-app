        ...
        <div class="bg-white h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ml-[5px] flex-none" src="{{tenant('icone') ? tenant('icone') : '/assets/images/icon-colege.png'}}" alt="image" />
                    <span class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline">{{ tenant('name') ? tenant('name') : config('app.name', '') }}</span>
                </a>
                <a href="javascript:;" class="collapse-icon w-8 h-8 rounded-full flex items-center hover:bg-gray-500/10 transition duration-300 rtl:rotate-180" @click="$store.app.toggleSidebar()">
                        ...
                        <li class="nav-item">
                            <a href="/apps/calendar" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black">Calendar</span>
                                </div>
                            </a>
                        </li>
                    </ul>
                        ...
                        <li class="nav-item">
                            <a href="/admin" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black">Empresas</span>
                                </div>
                            </a>
                        </li>
                    </ul>
